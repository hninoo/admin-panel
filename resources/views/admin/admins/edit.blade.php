<div id="kt_drawer_edit" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="chat" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '400px'}" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_drawer_edit_toggle" data-kt-drawer-close="#kt_drawer_chat_close">
    <!--begin::Messenger-->
    <div class="card w-100 rounded-0 border-0" id="kt_drawer_chat_messenger">
        ...
        <!--end::Card header-->
        <!--begin::Card body-->
        <div class="card-body" id="kt_drawer_edit_body">
            <div class="row mb-3">
                <!--begin::Col-->
                <div class="col-md-12">
                    <!--begin::Form-->
                    <form action="{{ route('admins.update', 0) }}" method="POST">
                        @method('PUT')
                        @csrf
